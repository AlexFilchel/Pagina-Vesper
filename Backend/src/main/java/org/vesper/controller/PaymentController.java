...
import org.vesper.service.payment.MercadoPagoService;
import org.vesper.service.payment.PaymentService;
import org.vesper.service.payment.UalaService;
...
public class PaymentController {
     ...
     */
    @PostMapping("/public/payments/webhook-mp")
    public ResponseEntity<String> handleWebhook(
        ...
        mercadoPagoService.procesarWebhook(rawPayload);
...
/**
     ...
     * Procesa los cambios de estado de un pago y actualiza la venta vinculada.
     */
    @PostMapping("/public/payments/webhook-uala")
    public ResponseEntity<String> handleWebhook(@RequestBody String rawPayload) {
        ualaService.procesarWebhook(rawPayload);
        return ResponseEntity.ok("Webhook procesado correctamente");
    }
    ...
    public RedirectView pagoExitoso(@RequestParam Map<String, String> params) {
        // Opcional: Aquí puedes guardar los 'params' (como el ID de pago) en tu DB 
        // usando el 'registroPagoRepository' si lo necesitas.
        
        // Redirige a la URL absoluta del frontend
        return new RedirectView(frontendBaseUrl + "/pago-exitoso.html");
    }

    @GetMapping("/public/payments/failure")
    public RedirectView pagoFallido(@RequestParam Map<String, String> params) {
        return new RedirectView(frontendBaseUrl + "/pago-fallido.html");
    }

    @GetMapping("/public/payments/pending")
    public RedirectView pagoPendiente(@RequestParam Map<String, String> params) {
        return new RedirectView(frontendBaseUrl + "/pago-pendiente.html");
    }
